...
var listMixin = {
    ...
    componentWillUnmount: function(){
        isReadyForNextMouseEvent = false;

//        document.removeEventListener('mouseup',this.bindMove.mouseupHandler.bind(this.bindMove));
    },
    ...
    bindMove: function(movedComponent, moveElemEvent) {
        ...
        this.mouseupHandler = function() {
            ...
            if(placeholder.className == "section") {
...
var itemMixin = {
    ...
    moveSetup: function(e) {
        if(isReadyForNextMouseEvent && e.srcElement.classList && e.srcElement.classList.contains("sortable")) {
            isReadyForNextMouseEvent = false;
